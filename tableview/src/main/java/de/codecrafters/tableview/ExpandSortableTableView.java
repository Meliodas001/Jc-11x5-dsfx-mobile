...
public class ExpandSortableTableView<T> extends ExpandTableView<T>  {
     ...
     */
    public ExpandSortableTableView(final Context context) {
        this(context, null);
    }
     ...
     */
    public ExpandSortableTableView(final Context context, final AttributeSet attributes) {
     ...
     */
    public ExpandSortableTableView(final Context context, final AttributeSet attributes, final int styleAttributes) {
