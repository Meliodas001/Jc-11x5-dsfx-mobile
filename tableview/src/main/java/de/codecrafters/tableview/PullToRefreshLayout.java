...
//	private String mLastUpdateTime;
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.view_pull_refreshheader, this, false);
		...
		mHeaderUpdateTextView.setText("更新于:"+sdf.format(date));
	...
	public void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.view_pull_refreshfooter, this, false);
...
//				Log.i(TAG, "pull up!parent view move!");
		...
		case MotionEvent.ACTION_CANCEL:
			...
			if (mPullState == PULL_DOWN_STATE) {
				...
				if (Math.abs(topMargin) >= mHeaderViewHeight+10) {
//						+ mFooterViewHeight
					// 开始执行footer 刷新
					footerRefreshing();
				} else {
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.mipmap.global_pulltorefresh_arrow);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.mipmap.global_pulltorefresh_arrow_up);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
