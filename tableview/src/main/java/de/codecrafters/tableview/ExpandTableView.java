...
import de.codecrafters.tableview.listeners.FooterRefreshListener;
...
/**
 * Created by yangsen on 2017/5/25.
 */

public class ExpandTableView  <T> extends LinearLayout {
     ...
     */
    public ExpandTableView(final Context context) {
        this(context, null);
    }
     ...
     */
    public ExpandTableView(final Context context, final AttributeSet attributes) {
     ...
     */
    public ExpandTableView(final Context context, final AttributeSet attributes, final int styleAttributes) {
    ...
    public void setRefreshListener (final FooterRefreshListener footerRefreshListener){
        pullToRefreshLayout.setOnFooterRefreshListener(new PullToRefreshLayout.OnFooterRefreshListener() {
            @Override
            public void onFooterRefresh(PullToRefreshLayout view) {
                footerRefreshListener.footerRefresh(view);
            }
        });
    }
    ...
    private void setupTableDataView(final AttributeSet attributes, final int styleAttributes) {
        ...
        LayoutParams dataViewLayoutParams1 = new LayoutParams(LayoutParams.MATCH_PARENT, 0);
        dataViewLayoutParams1.weight = 1;

        pullToRefreshLayout = new PullToRefreshLayout(getContext());
        pullToRefreshLayout.setLayoutParams(dataViewLayoutParams1);
        pullToRefreshLayout.setOrientation(LinearLayout.VERTICAL);
        pullToRefreshLayout.addView(tableDataView);
        pullToRefreshLayout.initListView(tableDataView);
        pullToRefreshLayout.addFooterView();
