 ...
 * 走势--使用
 */
public class LvCoinAdapter extends PoweredAdapter<CoinChangeRecord> {

    public LvCoinAdapter(Object... obj) {
        super(obj);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CoinChangeRecord item = getItem(position);
        vh.tvLeixing.setText(getChangeMc(item.getChangeType()));
