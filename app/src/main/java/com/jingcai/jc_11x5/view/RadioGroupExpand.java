...
/**
 * 自定义的RadioGroup
 * expand: 实现布局扩展（单个radioButton添加布局）
 * @author Administrator
 *
 */
public class RadioGroupExpand extends LinearLayout  {
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RadioGroupExpand group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RadioGroupExpand.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == RadioGroupExpand.this
