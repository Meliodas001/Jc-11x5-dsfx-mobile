 ...
 * 走势--使用
 */
public class LvXt1Adapter extends PoweredAdapter<KaiJiang_11x5> {

    public LvXt1Adapter(Object... obj) {
        super(obj);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.tvValue1.setText(item.getDaXiaoBi());
        vh.tvValue2.setText(item.getJiOuBi());
        vh.tvValue3.setText(item.getZhiHeBi());
        return convertView;
    }
