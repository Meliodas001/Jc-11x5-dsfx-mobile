...
/**
 * Created by yangsen on 2018/1/20.
 */

public class GvChannelAdapter extends PoweredAdapter<ResultBean.Channel> {


    public GvChannelAdapter(Object... obj) {
        super(obj);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder vh;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.gridview_item_channel, null);
