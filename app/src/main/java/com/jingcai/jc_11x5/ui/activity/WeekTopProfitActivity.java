...
public class WeekTopProfitActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_top_profit);
    ...
    private void requestData() {
        Jc11x5Factory.getInstance().getWeekTopProfit(mHandler);
    }
