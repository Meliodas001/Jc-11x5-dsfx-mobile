...
public class SeasonTopProfitActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_season_top_profit);
    ...
    private void requestData() {
        Jc11x5Factory.getInstance().getSeasonTopProfit(mHandler);
    }
